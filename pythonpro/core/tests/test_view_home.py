...
def test_payment_link_is_present(home_resp_open_subscriptions):
    ...
    """
    dj_assert_contains(home_resp_open_subscriptions, reverse('checkout:membership_lp'))
...
def test_payment_link_is_not_present(home_resp_closed_subscriptions):
    ...
    """
    dj_assert_not_contains(home_resp_closed_subscriptions, reverse('checkout:membership_lp'))
