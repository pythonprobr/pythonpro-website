...
class DiscordClient:
    def __init__(self, access_token, bot_token=None):
...
class DiscordCredentials:
    ...
    def generate_api_client(self, autorization_code: str) -> DiscordClient:
        data = {
        ...
        return DiscordClient(access_token, self._bot_token)
